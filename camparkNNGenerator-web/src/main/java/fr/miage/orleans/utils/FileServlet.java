...
public class FileServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        //this.basePath = new File(this.basePath).getParentFile().getParentFile().getParentFile().getParentFile().toPath().toString();
        System.out.println("path1 : " + this.basePath);
    }
            ...
            throws IOException
    {
        ...
        this.basePath = f.getParentFile().getParentFile().getParentFile().getParentFile().toPath().toString();
        System.out.println("path1 : " + this.basePath);
        */
        //f = new File(this.basePath);
        //this.basePath = f.getParentFile().toPath().toString();
        //System.out.println("path2 : " + this.basePath);
